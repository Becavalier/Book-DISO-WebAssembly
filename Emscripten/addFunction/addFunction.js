...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'addFunction.wast';
  var wasmBinaryFile = 'addFunction.wasm';
  var asmjsCodeFile = 'addFunction.temp.asm.js';
...
Module['wasmTableSize'] = 7520;

Module['wasmMaxTableSize'] = 7520;
...
var real__wrapper = asm["_wrapper"]; asm["_wrapper"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wrapper.apply(null, arguments);
};
...
var _wrapper = Module["_wrapper"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_wrapper"].apply(null, arguments) };
