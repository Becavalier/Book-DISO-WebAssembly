...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'debug.wast';
  var wasmBinaryFile = 'debug.wasm';
  var asmjsCodeFile = 'debug.temp.asm.js';
...
var real___Z3addcc = asm["__Z3addcc"]; asm["__Z3addcc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z3addcc.apply(null, arguments);
};
...
var __Z3addcc = Module["__Z3addcc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z3addcc"].apply(null, arguments) };
