...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'webidl_pointers.wast';
  var wasmBinaryFile = 'webidl_pointers.wasm';
  var asmjsCodeFile = 'webidl_pointers.temp.asm.js';
...
var real__emscripten_bind_WebIDL_returnAnyPtr_1 = asm["_emscripten_bind_WebIDL_returnAnyPtr_1"]; asm["_emscripten_bind_WebIDL_returnAnyPtr_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_WebIDL_returnAnyPtr_1.apply(null, arguments);
};

var real__emscripten_bind_WebIDL_returnNull_0 = asm["_emscripten_bind_WebIDL_returnNull_0"]; asm["_emscripten_bind_WebIDL_returnNull_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_WebIDL_returnNull_0.apply(null, arguments);
};

var real__emscripten_bind_WebIDL_returnVoidPtr_1 = asm["_emscripten_bind_WebIDL_returnVoidPtr_1"]; asm["_emscripten_bind_WebIDL_returnVoidPtr_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_WebIDL_returnVoidPtr_1.apply(null, arguments);
};
...
var _emscripten_bind_WebIDL_returnAnyPtr_1 = Module["_emscripten_bind_WebIDL_returnAnyPtr_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_WebIDL_returnAnyPtr_1"].apply(null, arguments) };
var _emscripten_bind_WebIDL_returnNull_0 = Module["_emscripten_bind_WebIDL_returnNull_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_WebIDL_returnNull_0"].apply(null, arguments) };
var _emscripten_bind_WebIDL_returnVoidPtr_1 = Module["_emscripten_bind_WebIDL_returnVoidPtr_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_WebIDL_returnVoidPtr_1"].apply(null, arguments) };
...
WebIDL.prototype['returnNull'] = WebIDL.prototype.returnNull = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  return wrapPointer(_emscripten_bind_WebIDL_returnNull_0(self), WebIDL);
};;

WebIDL.prototype['returnVoidPtr'] = WebIDL.prototype.returnVoidPtr = /** @suppress {undefinedVars, duplicate} */function(arg0) {
  var self = this.ptr;
  if (arg0 && typeof arg0 === 'object') arg0 = arg0.ptr;
  return wrapPointer(_emscripten_bind_WebIDL_returnVoidPtr_1(self, arg0), VoidPtr);
};;

WebIDL.prototype['returnAnyPtr'] = WebIDL.prototype.returnAnyPtr = /** @suppress {undefinedVars, duplicate} */function(arg0) {
  var self = this.ptr;
  if (arg0 && typeof arg0 === 'object') arg0 = arg0.ptr;
  return _emscripten_bind_WebIDL_returnAnyPtr_1(self, arg0);
};;
