...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'html5_mouse.wast';
  var wasmBinaryFile = 'html5_mouse.wasm';
  var asmjsCodeFile = 'html5_mouse.temp.asm.js';
...
var ASM_CONSTS = [function($0, $1) { let x = $0; let y = $1; document.querySelector("body").style['backgroundColor'] = `#${x}${y}`; }];
