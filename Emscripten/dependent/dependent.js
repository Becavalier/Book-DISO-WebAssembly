...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'dependent.wast';
  var wasmBinaryFile = 'dependent.wasm';
  var asmjsCodeFile = 'dependent.temp.asm.js';
...
var real__echo = asm["_echo"]; asm["_echo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__echo.apply(null, arguments);
};
...
var _echo = Module["_echo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_echo"].apply(null, arguments) };
