...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'html5_touch.wast';
  var wasmBinaryFile = 'html5_touch.wasm';
  var asmjsCodeFile = 'html5_touch.temp.asm.js';
...
var ASM_CONSTS = [function($0) { console.log(`Drag for "${$0.toFixed(2)}px"`); }];
