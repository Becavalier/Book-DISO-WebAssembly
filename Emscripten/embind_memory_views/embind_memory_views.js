...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'embind_memory_views.wast';
  var wasmBinaryFile = 'embind_memory_views.wasm';
  var asmjsCodeFile = 'embind_memory_views.temp.asm.js';
...
STATICTOP = STATIC_BASE + 8240;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_embind_memory_views_cc() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
var real___GLOBAL__sub_I_embind_memory_views_cc = asm["__GLOBAL__sub_I_embind_memory_views_cc"]; asm["__GLOBAL__sub_I_embind_memory_views_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_embind_memory_views_cc.apply(null, arguments);
};
...
var __GLOBAL__sub_I_embind_memory_views_cc = Module["__GLOBAL__sub_I_embind_memory_views_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_embind_memory_views_cc"].apply(null, arguments) };
...
__ATPOSTRUN__.push(() => {
  console.log(Module.getBytes());  // [97, 98, 99]；
});
