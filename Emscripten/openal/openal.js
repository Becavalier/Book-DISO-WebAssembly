...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'openal.data';
    var REMOTE_PACKAGE_BASE = 'openal.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_openal.data');

    };
    Module['addRunDependency']('datafile_openal.data');
 ...
 loadPackage({"files": [{"audio": 1, "start": 0, "crunched": 0, "end": 190764, "filename": "/audio.wav"}], "remote_package_size": 190764, "package_uuid": "e8d92088-312a-49a6-9fc5-e991c846222a"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'openal.wast';
  var wasmBinaryFile = 'openal.wasm';
  var asmjsCodeFile = 'openal.temp.asm.js';
