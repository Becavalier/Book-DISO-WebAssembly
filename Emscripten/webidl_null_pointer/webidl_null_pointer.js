...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'webidl_null_pointer.wast';
  var wasmBinaryFile = 'webidl_null_pointer.wasm';
  var asmjsCodeFile = 'webidl_null_pointer.temp.asm.js';
...
var real__emscripten_bind_WebIDL_returnNullPtr_0 = asm["_emscripten_bind_WebIDL_returnNullPtr_0"]; asm["_emscripten_bind_WebIDL_returnNullPtr_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_WebIDL_returnNullPtr_0.apply(null, arguments);
};
...
var _emscripten_bind_WebIDL_returnNullPtr_0 = Module["_emscripten_bind_WebIDL_returnNullPtr_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_WebIDL_returnNullPtr_0"].apply(null, arguments) };
...
WebIDL.prototype['returnNullPtr'] = WebIDL.prototype.returnNullPtr = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  return wrapPointer(_emscripten_bind_WebIDL_returnNullPtr_0(self), WebIDL);
};;
