...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'file_basic.data';
    var REMOTE_PACKAGE_BASE = 'file_basic.data';
...
Module['FS_createPath']('/', 'data', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_file_basic.data');

    };
    Module['addRunDependency']('datafile_file_basic.data');
 ...
 loadPackage({"files": [{"audio": 0, "start": 0, "crunched": 0, "end": 2001, "filename": "/data/core_data.txt"}], "remote_package_size": 2001, "package_uuid": "6c516cf9-3401-45df-abb4-a36392f7192e"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'file_basic.wast';
  var wasmBinaryFile = 'file_basic.wasm';
  var asmjsCodeFile = 'file_basic.temp.asm.js';
