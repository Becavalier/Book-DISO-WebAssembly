...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'em_js.wast';
  var wasmBinaryFile = 'em_js.wasm';
  var asmjsCodeFile = 'em_js.temp.asm.js';
...
function _add(x,y){ console.log(x, y); return x + y; }
...
var real____em_js__add = asm["___em_js__add"]; asm["___em_js__add"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__add.apply(null, arguments);
};
...
var ___em_js__add = Module["___em_js__add"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__add"].apply(null, arguments) };
