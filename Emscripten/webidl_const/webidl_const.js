...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'webidl_const.wast';
  var wasmBinaryFile = 'webidl_const.wasm';
  var asmjsCodeFile = 'webidl_const.temp.asm.js';
...
var real__emscripten_bind_WebIDL_get_y_0 = asm["_emscripten_bind_WebIDL_get_y_0"]; asm["_emscripten_bind_WebIDL_get_y_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_WebIDL_get_y_0.apply(null, arguments);
};
...
var real__emscripten_bind_WebIDL_set_y_1 = asm["_emscripten_bind_WebIDL_set_y_1"]; asm["_emscripten_bind_WebIDL_set_y_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__emscripten_bind_WebIDL_set_y_1.apply(null, arguments);
};
...
var _emscripten_bind_WebIDL_get_y_0 = Module["_emscripten_bind_WebIDL_get_y_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_WebIDL_get_y_0"].apply(null, arguments) };
...
var _emscripten_bind_WebIDL_set_y_1 = Module["_emscripten_bind_WebIDL_set_y_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_WebIDL_set_y_1"].apply(null, arguments) };
...
WebIDL.prototype['passThroughByReference'] = WebIDL.prototype.passThroughByReference = /** @suppress {undefinedVars, duplicate} */function(arg0) {
  ...
  WebIDL.prototype['get_y'] = WebIDL.prototype.get_y = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  return _emscripten_bind_WebIDL_get_y_0(self);
};
    WebIDL.prototype['set_y'] = WebIDL.prototype.set_y = /** @suppress {undefinedVars, duplicate} */function(arg0) {
  var self = this.ptr;
  if (arg0 && typeof arg0 === 'object') arg0 = arg0.ptr;
  _emscripten_bind_WebIDL_set_y_1(self, arg0);
};
